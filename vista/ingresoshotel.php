...
<table style="width:80%">
    ...
    <tr >
        ...
        <th scope="col" style="float:right">Fecha:<input type="datetime" name="fecha"  value="<?php echo date("Y-m-d");?>"></th> 
            ...
            <tr>
            <td>Numero de Reservaci&oacute;n</td><td><input type="text" id="sit3" name="Name" id="Name" placeholder="10101010" autocomplete="on" required></td>
            </tr>
        
            <tr>    
            <td>Tipo de Habitaci&oacute;n</td><td>
            ...
            <td>Numero:</td><td><p id="demo"></p></td>
                
            <td>Personas</td><td><input type="number" id="sit3" name="Name" id="Name"  autocomplete="on" required></td>
            </tr>
            
            <tr>
                
            <td>Nombre de Cliente</td><td colspan="2"><input type="text" name="Name" id="Name"  autocomplete="on" required></td>
            
            <td colspan="2">Cliente a Credito</td><td><select  name="room" id="room"> <option value=""></option><?php include("../modelo/conexion.php"); $consulta="SELECT ID,name FROM clientecred"; $ejecutar=mysqli_query($conexion,$consulta) or die(mysqli_error($conexion)); ?> <?php foreach ($ejecutar as $opciones):?> <option value="<?php echo $opciones['ID']?>" autocomplete="on"><?php echo $opciones['name']?></option> <?php endforeach ?> </select></td>
                
            
            </tr>
            
            <tr>    
            <td>Fecha de Entrada:</td><td><input type="date" id="sit3" name="Idate" id="Idate" required></td>
                
            <td>Fecha de Salida:</td><td><input type="date" id="sit3" name="Idate" id="Idate" required></td>
                
            <td>(D&iacute;as)</td><td><input type="number" id="sit3" name="Name" id="Name"  autocomplete="on" required></td>
            </tr>
            
            <tr>
                
            <td colspan="2">Precio Unitario de la Habitaci&oacute;n:</td><td><input type="number" id="sit3" name="Name" id="Name"  autocomplete="on" required></td>
                
            <td colspan="2">Total de Ingreso:</td><td><input type="number" id="sit3" name="Name" id="Name"  autocomplete="on" required></td>    
            </tr>
...
<?php include_once("mapacalendario.php") ?>

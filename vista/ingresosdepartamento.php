...
<label>Ingreso de Departamento</label>    
...
<table style="width:80%">
    ...
    <tr >
        ...
        <th scope="col" style="float:right">Fecha:<input type="datetime" name="fecha"  value="<?php echo date("Y-m-d");?>"></th> 
            ...
            <option value=""></option>
            <option value="1">Departamento No. 01</option>
            <option value="2">Departamento No. 02</option>
            <option value="3">Departamento No. 03</option>
            <option value="4">Departamento No. 04</option>
            </select>
            ...
            <td>Cantidad de Meses a Pagar</td><td colspan="2"><input type="number" name="Name" id="Name"  autocomplete="on" required></td>  

...
<label>Ingreso de Restaurante</label>    
...
<table style="width:80%">
    ...
    <tr >
        ...
        <th scope="col" style="float:right">Fecha:<input type="datetime" name="fecha"  value="<?php echo date("Y-m-d");?>"></th> 
            ...
            <option value="4">Entrega a Domicilio</option>
            <option value="5">Entrega en Sitio</option>
            </select>
            ...
            <option value="5">Banquete</option>
            <option value="6">Coffee Break</option>
            <option value="7">Charola Huasteca</option>
            </select>
                
            </td>
                
            <td>Cliente a Credito</td>
            
            <td colspan="2">
                
            <select id="clienteacredito">
                
            <?php
            include("../modelo/conexion.php");
            $consulta="SELECT ID,name FROM clientecred";
            ...
            <td>N&uacute;mero de Comanda:</td><td colspan="2"><input type="number" id="sit3" name="Name" id="Name"  autocomplete="on" required></td>
                
            <td>Cantidad:</td><td colspan="2"><input type="number" id="sit3" name="Name" id="Name"  autocomplete="on" required></td>    

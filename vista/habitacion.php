...
<section style="width: 99%;margin-left:0.5%">
        ...
        <label style="color:white">Numero de habitaci&oacute;n: <?php echo $_SESSION["IDss"]?></label><label><?php echo $array['IDr']?></label><br>
...
<table id="tablaT" border="1" class="table table-bordered table-striped mb-0">
    ...
    <th scope="col" style="width:1%">Ultimo mantenimiento</th>
    <th scope="col" style="width:1%">Proximo Mantenimiento</th>

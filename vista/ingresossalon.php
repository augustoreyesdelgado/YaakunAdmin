...
<label>Ingreso de Sal&oacute;n</label>    
...
<table style="width:80%">
    ...
    <tr >
        ...
        <th scope="col" style="float:right">Fecha:<input type="datetime" name="fecha"  value="<?php echo date("Y-m-d");?>"></th> 
            ...
            <select id="tiposerviciosalon">
                
            <?php
            include("../modelo/conexion.php");
            $consulta="SELECT ID,name FROM tiposerviciosalon";
            $ejecutar=mysqli_query($conexion,$consulta) or die(mysqli_error($conexion));
                ?>
                <option value=""></option>
                <?php foreach ($ejecutar as $opciones):?>
                <option value="<?php echo $opciones['ID']?>" autocomplete="on"><?php echo $opciones['name']?></option>
                <?php endforeach ?>
            ...
            <td>Cantidad de Meseros:</td><td colspan="2"><input type="number" id="sit3" name="Name" id="Name"  autocomplete="on" required></td>
                
            <td>N&uacute;mero de Asistentes:</td><td colspan="2"><input type="number" id="sit3" name="Name" id="Name"  autocomplete="on" required></td>    
            ...
            <td>Horario Disponibilidad:</td><td colspan="2"><input type="number" id="sit3" name="Name" id="Name"  autocomplete="on" required></td>
                
            <td>Precio:</td><td colspan="2"><input type="number" id="sit3" name="Name" id="Name"  autocomplete="on" required></td>    

...
<section style="width: 99%;margin-left:0.5%">
        ...
        <center><b style="font-family:Helvetica;color:white">Buscar Area</b>
            <br>
...
$sql="Select r.IDr,r.status, r.sort,r.rname, c.Rsort from rooms as r inner join rcategories as c where r.sort=IDrc and r.rname like '%".$_POST["nombre"]."%' and c.Rsort like '%".$_POST["categoria"]."%' and r.status like '%".$_POST["estado"]."%' and r.sort='9' order by r.rname";
